...
export type GetApiV1OrganizationsOrgIdContactsSort = typeof GetApiV1OrganizationsOrgIdContactsSort[keyof typeof GetApiV1OrganizationsOrgIdContactsSort];


export const GetApiV1OrganizationsOrgIdContactsSort = {
  name: 'name',
  createdAt: 'createdAt',
} as const;
