...
export type SetMessageConsentInputStatus = typeof SetMessageConsentInputStatus[keyof typeof SetMessageConsentInputStatus];


export const SetMessageConsentInputStatus = {
  UNKNOWN: 'UNKNOWN',
  GRANTED: 'GRANTED',
  REVOKED: 'REVOKED',
} as const;
