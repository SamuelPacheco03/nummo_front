 ...
 */
import type { PlaygroundTraceDetailMessagesItem } from './playgroundTraceDetailMessagesItem';

export type PlaygroundTraceDetail = {
  system: string;
  contextBlock: string;
  messages: PlaygroundTraceDetailMessagesItem[];
  toolNames: string[];
} | null;
