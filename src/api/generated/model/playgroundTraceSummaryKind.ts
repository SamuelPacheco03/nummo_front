...
export type PlaygroundTraceSummaryKind = typeof PlaygroundTraceSummaryKind[keyof typeof PlaygroundTraceSummaryKind];


export const PlaygroundTraceSummaryKind = {
  turn: 'turn',
  title: 'title',
  summary: 'summary',
} as const;
