...
export type CreatePaymentMethodMethodType = typeof CreatePaymentMethodMethodType[keyof typeof CreatePaymentMethodMethodType];


export const CreatePaymentMethodMethodType = {
  CASH: 'CASH',
