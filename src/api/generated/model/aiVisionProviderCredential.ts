 ...
 */
import type { AiVisionProviderCredentialProvider } from './aiVisionProviderCredentialProvider';

export interface AiVisionProviderCredential {
  provider: AiVisionProviderCredentialProvider;
  model: string;
  apiKeyLast4: string;
  isActive: boolean;
