...
export type PlaygroundTraceSummaryOrigin = typeof PlaygroundTraceSummaryOrigin[keyof typeof PlaygroundTraceSummaryOrigin];


export const PlaygroundTraceSummaryOrigin = {
  user: 'user',
