 ...
 */
import type { AiVoiceProviderCatalogEntryProvider } from './aiVoiceProviderCatalogEntryProvider';

export interface AiVoiceProviderCatalogEntry {
  provider: AiVoiceProviderCatalogEntryProvider;
  label: string;
