...
export type PlaygroundTraceSummaryProvider = typeof PlaygroundTraceSummaryProvider[keyof typeof PlaygroundTraceSummaryProvider];


export const PlaygroundTraceSummaryProvider = {
  anthropic: 'anthropic',
  openai: 'openai',
  google: 'google',
  deepseek: 'deepseek',
