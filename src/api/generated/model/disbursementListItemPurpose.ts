...
export type DisbursementListItemPurpose = typeof DisbursementListItemPurpose[keyof typeof DisbursementListItemPurpose];


export const DisbursementListItemPurpose = {
  EXPENSE: 'EXPENSE',
  ADVANCE: 'ADVANCE',
