 ...
 */
import type { PlaygroundTraceDetailMessagesItemRole } from './playgroundTraceDetailMessagesItemRole';

export type PlaygroundTraceDetailMessagesItem = {
  role: PlaygroundTraceDetailMessagesItemRole;
  content: string;
};
