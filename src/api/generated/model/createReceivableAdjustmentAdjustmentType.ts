...
export type CreateReceivableAdjustmentAdjustmentType = typeof CreateReceivableAdjustmentAdjustmentType[keyof typeof CreateReceivableAdjustmentAdjustmentType];


export const CreateReceivableAdjustmentAdjustmentType = {
  DISCOUNT: 'DISCOUNT',
