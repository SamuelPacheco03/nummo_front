...
export type CreateFinancialAccountAccountType = typeof CreateFinancialAccountAccountType[keyof typeof CreateFinancialAccountAccountType];


export const CreateFinancialAccountAccountType = {
  CASH: 'CASH',
  BANK: 'BANK',
