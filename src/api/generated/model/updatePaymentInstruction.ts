 ...
 */
import type { UpdatePaymentInstructionDetails } from './updatePaymentInstructionDetails';

export interface UpdatePaymentInstruction {
  label?: string | null;
  details?: UpdatePaymentInstructionDetails;
