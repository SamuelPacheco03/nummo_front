...
export type UpdateContactInputContactType = typeof UpdateContactInputContactType[keyof typeof UpdateContactInputContactType];


export const UpdateContactInputContactType = {
  PERSON: 'PERSON',
  COMPANY: 'COMPANY',
} as const;
