...
export type RegisterDisbursementPurpose = typeof RegisterDisbursementPurpose[keyof typeof RegisterDisbursementPurpose];


export const RegisterDisbursementPurpose = {
  EXPENSE: 'EXPENSE',
  ADVANCE: 'ADVANCE',
