...
export type PlaygroundActiveModelProvider = typeof PlaygroundActiveModelProvider[keyof typeof PlaygroundActiveModelProvider];


export const PlaygroundActiveModelProvider = {
  anthropic: 'anthropic',
  openai: 'openai',
  google: 'google',
  deepseek: 'deepseek',
