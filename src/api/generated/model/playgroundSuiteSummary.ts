 ...
 */
import type { PlaygroundSuiteSummaryProvider } from './playgroundSuiteSummaryProvider';

export interface PlaygroundSuiteSummary {
  ...
  /**
     ...
     */
  passed: number;
  provider: PlaygroundSuiteSummaryProvider;
  model: string;
  systemOverridden: boolean;
  /**
     * @minimum -9007199254740991
     * @maximum 9007199254740991
     */
