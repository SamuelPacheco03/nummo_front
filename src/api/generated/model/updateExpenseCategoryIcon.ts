...
export type UpdateExpenseCategoryIcon = typeof UpdateExpenseCategoryIcon[keyof typeof UpdateExpenseCategoryIcon] | null;


export const UpdateExpenseCategoryIcon = {
  tag: 'tag',
  folder: 'folder',
  star: 'star',
  bookmark: 'bookmark',
