...
export type PlaygroundActiveModelSource = typeof PlaygroundActiveModelSource[keyof typeof PlaygroundActiveModelSource];


export const PlaygroundActiveModelSource = {
  PLATFORM: 'PLATFORM',
  BYOK: 'BYOK',
} as const;
