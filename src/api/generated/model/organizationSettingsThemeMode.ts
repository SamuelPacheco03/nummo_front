...
export type OrganizationSettingsThemeMode = typeof OrganizationSettingsThemeMode[keyof typeof OrganizationSettingsThemeMode];


export const OrganizationSettingsThemeMode = {
  LIGHT: 'LIGHT',
  DARK: 'DARK',
  SYSTEM: 'SYSTEM',
} as const;
