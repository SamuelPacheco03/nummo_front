...
export type AiProviderCatalogEntryProvider = typeof AiProviderCatalogEntryProvider[keyof typeof AiProviderCatalogEntryProvider];


export const AiProviderCatalogEntryProvider = {
  anthropic: 'anthropic',
  openai: 'openai',
  google: 'google',
  deepseek: 'deepseek',
