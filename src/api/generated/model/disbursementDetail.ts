...
import type { DisbursementAllocation } from './disbursementAllocation';
import type { DisbursementUnallocated } from './disbursementUnallocated';

export interface DisbursementDetail {
  disbursement: Disbursement;
  allocations: DisbursementAllocation[];
  unallocated: DisbursementUnallocated;
}
