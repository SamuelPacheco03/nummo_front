...
export type ContactRelationshipDirection = typeof ContactRelationshipDirection[keyof typeof ContactRelationshipDirection];


export const ContactRelationshipDirection = {
  OUTGOING: 'OUTGOING',
  INCOMING: 'INCOMING',
} as const;
