...
export type GetApiV1AdminPlaygroundRunsOrigin = typeof GetApiV1AdminPlaygroundRunsOrigin[keyof typeof GetApiV1AdminPlaygroundRunsOrigin];


export const GetApiV1AdminPlaygroundRunsOrigin = {
  user: 'user',
