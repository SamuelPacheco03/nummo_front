...
export type AssistantSettingsActiveProvider = typeof AssistantSettingsActiveProvider[keyof typeof AssistantSettingsActiveProvider] | null;


export const AssistantSettingsActiveProvider = {
  anthropic: 'anthropic',
  openai: 'openai',
  google: 'google',
  deepseek: 'deepseek',
