...
export type AdminOrganizationDetailDtoPlanCode = typeof AdminOrganizationDetailDtoPlanCode[keyof typeof AdminOrganizationDetailDtoPlanCode];


export const AdminOrganizationDetailDtoPlanCode = {
  FREE: 'FREE',
  BASIC: 'BASIC',
  PRO: 'PRO',
