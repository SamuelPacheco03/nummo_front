 ...
 */
import type { MessageConsentChannel } from './messageConsentChannel';
import type { MessageConsentSource } from './messageConsentSource';
import type { MessageConsentStatus } from './messageConsentStatus';

export interface MessageConsent {
  channel: MessageConsentChannel;
  address: string;
  contactId: string | null;
  status: MessageConsentStatus;
