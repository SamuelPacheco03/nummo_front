...
export type AiProviderCredentialProvider = typeof AiProviderCredentialProvider[keyof typeof AiProviderCredentialProvider];


export const AiProviderCredentialProvider = {
  anthropic: 'anthropic',
  openai: 'openai',
  google: 'google',
  deepseek: 'deepseek',
