...
export type AiVoiceProviderCredentialProvider = typeof AiVoiceProviderCredentialProvider[keyof typeof AiVoiceProviderCredentialProvider];


export const AiVoiceProviderCredentialProvider = {
  deepgram: 'deepgram',
