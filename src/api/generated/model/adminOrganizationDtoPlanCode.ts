...
export type AdminOrganizationDtoPlanCode = typeof AdminOrganizationDtoPlanCode[keyof typeof AdminOrganizationDtoPlanCode];


export const AdminOrganizationDtoPlanCode = {
  FREE: 'FREE',
  BASIC: 'BASIC',
  PRO: 'PRO',
