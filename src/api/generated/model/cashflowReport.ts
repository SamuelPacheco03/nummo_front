 ...
 */
import type { CashflowReportCurrent } from './cashflowReportCurrent';
import type { CashflowReportPrevious } from './cashflowReportPrevious';

export interface CashflowReport {
  from: string;
  to: string;
  current: CashflowReportCurrent;
  previous: CashflowReportPrevious;
}
