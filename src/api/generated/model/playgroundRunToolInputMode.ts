...
export type PlaygroundRunToolInputMode = typeof PlaygroundRunToolInputMode[keyof typeof PlaygroundRunToolInputMode];


export const PlaygroundRunToolInputMode = {
  read_only: 'read_only',
