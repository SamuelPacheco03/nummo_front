 ...
 */
import type { AiVoiceProviderCredentialProvider } from './aiVoiceProviderCredentialProvider';

export interface AiVoiceProviderCredential {
  provider: AiVoiceProviderCredentialProvider;
  model: string;
  apiKeyLast4: string;
  isActive: boolean;
