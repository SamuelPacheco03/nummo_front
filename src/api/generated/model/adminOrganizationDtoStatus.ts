...
export type AdminOrganizationDtoStatus = typeof AdminOrganizationDtoStatus[keyof typeof AdminOrganizationDtoStatus];


export const AdminOrganizationDtoStatus = {
  ACTIVE: 'ACTIVE',
  SUSPENDED: 'SUSPENDED',
  ARCHIVED: 'ARCHIVED',
} as const;
