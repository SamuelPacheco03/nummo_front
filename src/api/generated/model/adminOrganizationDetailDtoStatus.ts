...
export type AdminOrganizationDetailDtoStatus = typeof AdminOrganizationDetailDtoStatus[keyof typeof AdminOrganizationDetailDtoStatus];


export const AdminOrganizationDetailDtoStatus = {
  ACTIVE: 'ACTIVE',
  SUSPENDED: 'SUSPENDED',
  ARCHIVED: 'ARCHIVED',
} as const;
