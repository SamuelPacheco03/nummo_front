...
export type PlaygroundCompareInputRole = typeof PlaygroundCompareInputRole[keyof typeof PlaygroundCompareInputRole];


export const PlaygroundCompareInputRole = {
  OWNER: 'OWNER',
  ADMIN: 'ADMIN',
