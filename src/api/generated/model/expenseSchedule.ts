...
import type { ExpenseScheduleRecurrenceType } from './expenseScheduleRecurrenceType';
import type { ExpenseScheduleStatus } from './expenseScheduleStatus';
...
export interface ExpenseSchedule {
  ...
  agreedAmount: string;
  currency: string;
  recurrenceType: ExpenseScheduleRecurrenceType;
  startDate: string;
  endDate: string | null;
  /**
