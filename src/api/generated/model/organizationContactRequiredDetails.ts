 ...
 */
import type { OrganizationContactRequiredDetailsReason } from './organizationContactRequiredDetailsReason';

export interface OrganizationContactRequiredDetails {
  reason: OrganizationContactRequiredDetailsReason;
  fields: string[];
}
