...
export type PlaygroundSaveCaseInputRole = typeof PlaygroundSaveCaseInputRole[keyof typeof PlaygroundSaveCaseInputRole];


export const PlaygroundSaveCaseInputRole = {
  OWNER: 'OWNER',
  ADMIN: 'ADMIN',
