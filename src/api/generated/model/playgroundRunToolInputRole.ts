...
export type PlaygroundRunToolInputRole = typeof PlaygroundRunToolInputRole[keyof typeof PlaygroundRunToolInputRole];


export const PlaygroundRunToolInputRole = {
  OWNER: 'OWNER',
  ADMIN: 'ADMIN',
