 ...
 */
import type { CreateReceivableAdjustmentAdjustmentType } from './createReceivableAdjustmentAdjustmentType';

export interface CreateReceivableAdjustment {
  adjustmentType: CreateReceivableAdjustmentAdjustmentType;
  /** @pattern ^\d+(\.\d{1,2})?$ */
  amount: string;
  reason?: string | null;
}
