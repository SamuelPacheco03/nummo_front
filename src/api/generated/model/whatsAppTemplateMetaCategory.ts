...
export type WhatsAppTemplateMetaCategory = typeof WhatsAppTemplateMetaCategory[keyof typeof WhatsAppTemplateMetaCategory];


export const WhatsAppTemplateMetaCategory = {
  UTILITY: 'UTILITY',
  MARKETING: 'MARKETING',
