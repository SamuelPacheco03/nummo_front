...
export type PlaygroundGenerationProvider = typeof PlaygroundGenerationProvider[keyof typeof PlaygroundGenerationProvider];


export const PlaygroundGenerationProvider = {
  anthropic: 'anthropic',
  openai: 'openai',
  google: 'google',
  deepseek: 'deepseek',
