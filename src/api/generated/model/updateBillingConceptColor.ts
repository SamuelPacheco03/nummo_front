...
export type UpdateBillingConceptColor = typeof UpdateBillingConceptColor[keyof typeof UpdateBillingConceptColor] | null;


export const UpdateBillingConceptColor = {
  slate: 'slate',
  gray: 'gray',
  red: 'red',
  orange: 'orange',
