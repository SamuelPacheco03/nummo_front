...
export type BillingAgreementRecurrenceType = typeof BillingAgreementRecurrenceType[keyof typeof BillingAgreementRecurrenceType];


export const BillingAgreementRecurrenceType = {
  MONTHLY: 'MONTHLY',
} as const;
