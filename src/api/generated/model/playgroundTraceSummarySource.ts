...
export type PlaygroundTraceSummarySource = typeof PlaygroundTraceSummarySource[keyof typeof PlaygroundTraceSummarySource];


export const PlaygroundTraceSummarySource = {
  PLATFORM: 'PLATFORM',
  BYOK: 'BYOK',
} as const;
