...
export type UpdatePaymentMethodMethodType = typeof UpdatePaymentMethodMethodType[keyof typeof UpdatePaymentMethodMethodType];


export const UpdatePaymentMethodMethodType = {
  CASH: 'CASH',
