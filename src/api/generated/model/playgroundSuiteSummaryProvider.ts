...
export type PlaygroundSuiteSummaryProvider = typeof PlaygroundSuiteSummaryProvider[keyof typeof PlaygroundSuiteSummaryProvider];


export const PlaygroundSuiteSummaryProvider = {
  anthropic: 'anthropic',
  openai: 'openai',
  google: 'google',
  deepseek: 'deepseek',
