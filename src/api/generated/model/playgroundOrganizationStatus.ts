...
export type PlaygroundOrganizationStatus = typeof PlaygroundOrganizationStatus[keyof typeof PlaygroundOrganizationStatus];


export const PlaygroundOrganizationStatus = {
  ACTIVE: 'ACTIVE',
  SUSPENDED: 'SUSPENDED',
  ARCHIVED: 'ARCHIVED',
} as const;
