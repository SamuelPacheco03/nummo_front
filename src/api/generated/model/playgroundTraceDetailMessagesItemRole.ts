...
export type PlaygroundTraceDetailMessagesItemRole = typeof PlaygroundTraceDetailMessagesItemRole[keyof typeof PlaygroundTraceDetailMessagesItemRole];


export const PlaygroundTraceDetailMessagesItemRole = {
  user: 'user',
  assistant: 'assistant',
} as const;
