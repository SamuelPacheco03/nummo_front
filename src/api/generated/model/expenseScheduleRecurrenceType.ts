...
export type ExpenseScheduleRecurrenceType = typeof ExpenseScheduleRecurrenceType[keyof typeof ExpenseScheduleRecurrenceType];


export const ExpenseScheduleRecurrenceType = {
  MONTHLY: 'MONTHLY',
} as const;
