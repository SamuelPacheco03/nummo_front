...
export type UpdateExpenseCategoryScope = typeof UpdateExpenseCategoryScope[keyof typeof UpdateExpenseCategoryScope];


export const UpdateExpenseCategoryScope = {
  BUSINESS: 'BUSINESS',
  PERSONAL: 'PERSONAL',
} as const;
