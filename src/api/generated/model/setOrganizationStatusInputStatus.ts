...
export type SetOrganizationStatusInputStatus = typeof SetOrganizationStatusInputStatus[keyof typeof SetOrganizationStatusInputStatus];


export const SetOrganizationStatusInputStatus = {
  ACTIVE: 'ACTIVE',
  SUSPENDED: 'SUSPENDED',
} as const;
