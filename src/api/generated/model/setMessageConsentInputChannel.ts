...
export type SetMessageConsentInputChannel = typeof SetMessageConsentInputChannel[keyof typeof SetMessageConsentInputChannel];


export const SetMessageConsentInputChannel = {
  WHATSAPP: 'WHATSAPP',
} as const;
