 ...
 */
import type { BillingConceptColor } from './billingConceptColor';
import type { BillingConceptIcon } from './billingConceptIcon';
...
export interface BillingConcept {
  ...
  icon: BillingConceptIcon;
  color: BillingConceptColor;
  /**
