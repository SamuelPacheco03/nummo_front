...
export type CreateExpenseCategoryScope = typeof CreateExpenseCategoryScope[keyof typeof CreateExpenseCategoryScope];


export const CreateExpenseCategoryScope = {
  BUSINESS: 'BUSINESS',
  PERSONAL: 'PERSONAL',
} as const;
