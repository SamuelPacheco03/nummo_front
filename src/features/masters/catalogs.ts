...
const ICON_KEYWORDS: Record<IconKey, string> = {
  ...
  boxes: 'inventario lote bodega varios',
  ...
  'hand-coins': 'prestamo aporte donacion propina comision',
  'credit-card': 'tarjeta credito debito datafono',
  'piggy-bank': 'ahorro fondo',
  vault: 'caja fuerte reserva ahorro',
  ...
  scale: 'balance justicia peso equilibrio',
  gavel: 'juridico legal demanda cobro abogado',
  home: 'hogar arriendo alquiler vivienda apartamento',
  'door-open': 'entrada acceso local puerta',
  key: 'arriendo deposito llaves inmueble',
  lightbulb: 'energia electricidad luz servicio',
  lamp: 'iluminacion luz lampara',
  plug: 'energia electricidad enchufe',
  ...
  armchair: 'muebles sala poltrona',
  bed: 'habitacion dormitorio hospedaje cama',
  bath: 'bano tina aseo',
  'shower-head': 'ducha agua bano',
  'washing-machine': 'lavanderia ropa lavadora',
  refrigerator: 'nevera refrigerador electrodomestico',
  car: 'auto vehiculo carro parqueadero',
  'car-front': 'carro auto vehiculo',
  'car-taxi-front': 'taxi carrera transporte',
  bus: 'transporte publico pasaje',
  'bus-front': 'ruta escolar transporte colegio bus',
  fuel: 'gasolina combustible acpm',
  plane: 'vuelo avion viaje tiquete',
  bike: 'bici ciclismo',
  truck: 'camion flete envio acarreo',
  tractor: 'agro finca maquinaria campo',
  ambulance: 'emergencia traslado ambulancia',
  ship: 'barco maritimo',
  sailboat: 'velero paseo barco',
  'train-front': 'tren metro',
  utensils: 'comida almuerzo restaurante alimentacion',
  'chef-hat': 'cocina catering chef restaurante',
  pizza: 'comida rapida pizza',
  sandwich: 'refrigerio lonchera sandwich',
  salad: 'ensalada saludable almuerzo',
  soup: 'sopa caldo almuerzo',
  beef: 'carne carniceria proteina',
  fish: 'pescado pescaderia mariscos',
  egg: 'huevo desayuno',
  croissant: 'panaderia pan reposteria',
  cookie: 'galleta postre snack',
  'ice-cream-cone': 'helado postre heladeria',
  ...
  clapperboard: 'produccion rodaje video claqueta',
  camera: 'foto fotografia camara',
  music: 'musica spotify suscripcion',
  headphones: 'audio musica audifonos',
  mic: 'microfono podcast grabacion sonido',
  guitar: 'guitarra musica instrumento clase',
  'gamepad-2': 'juego videojuego consola',
  puzzle: 'juego didactico rompecabezas',
  ...
  syringe: 'vacuna inyeccion aplicacion',
  bandage: 'curacion venda herida',
  thermometer: 'termometro fiebre control',
  stethoscope: 'medico consulta cita',
  brain: 'psicologia terapia neurologia cerebro',
  eye: 'optometria vision ojo',
  glasses: 'gafas lentes optica',
  microscope: 'laboratorio examen microscopio',
  'test-tube': 'laboratorio examen muestra prueba',
  hospital: 'clinica hospital urgencias',
  'graduation-cap': 'matricula grado universidad colegio pension',
  school: 'colegio escuela institucion',
  library: 'biblioteca libros',
  'book-open': 'libro texto lectura',
  notebook: 'cuaderno utiles apuntes',
  'notebook-pen': 'apuntes tarea cuaderno',
  backpack: 'mochila utiles colegio',
  pencil: 'lapiz utiles papeleria',
  highlighter: 'resaltador utiles papeleria',
  ruler: 'regla utiles medida',
  presentation: 'clase taller capacitacion presentacion',
  award: 'premio bono incentivo reconocimiento',
  briefcase: 'trabajo negocio honorarios',
  building: 'edificio sede inmueble administracion',
  'building-2': 'empresa oficina sede arriendo',
  warehouse: 'bodega almacen inventario',
  hotel: 'hotel hospedaje alojamiento',
  users: 'equipo nomina personal empleados',
  'user-round': 'persona cliente proveedor',
  badge: 'carnet credencial identificacion',
  handshake: 'acuerdo convenio contrato',
  megaphone: 'publicidad marketing pauta',
  network: 'red conexion infraestructura',
  wrench: 'mantenimiento reparacion tecnico',
  hammer: 'obra construccion remodelacion',
  'hard-hat': 'obra seguridad industrial casco',
  ...
  keyboard: 'teclado periferico equipo',
  mouse: 'raton periferico equipo',
  headset: 'diadema callcenter soporte audio',
  printer: 'impresora impresion papeleria',
  scan: 'escaner escaneo digitalizacion',
  'qr-code': 'qr codigo pago',
  dog: 'perro mascota veterinario',
  cat: 'gato mascota veterinario',
  'paw-print': 'mascota huella veterinaria',
  bird: 'ave pajaro mascota',
  rabbit: 'conejo mascota',
  bone: 'hueso mascota veterinaria',
  trees: 'jardineria zonas verdes ambiental arboles',
  ...
  crown: 'premium vip plan corona',
  umbrella: 'seguro proteccion lluvia sombrilla',
  sparkles: 'limpieza aseo destacado brillo',
