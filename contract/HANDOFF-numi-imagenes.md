<!--
  ...
  Se copia el documento de origen en vez de reescribirlo aqui: el original se
  mantiene contra el codigo, y dos copias del mismo texto se separan a la
  primera correccion que solo se haga en una.
-->
